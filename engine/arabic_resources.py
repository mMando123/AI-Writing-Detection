...
ENGLISH_SYNONYMS = {
    ...
    "also": ["additionally", "moreover", "furthermore", "besides", "likewise"],
    "for example": ["for instance", "such as", "to illustrate", "as in", "like"],
    "in addition": ["furthermore", "moreover", "on top of that", "what's more"],
    "because": ["since", "as", "given that", "due to the fact that", "owing to"],
    "although": ["even though", "despite the fact that", "while", "whereas"],
    "in conclusion": ["to sum up", "ultimately", "all things considered", "in the end"],
}
